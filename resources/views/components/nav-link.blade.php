{{--@props seperti parameter function yang ada nilai defaultnya, jadi kalau misalnya kita tidak memanggil attributes active di component nilai defaultnya akan false--}}
@props([ "active" => false] )
